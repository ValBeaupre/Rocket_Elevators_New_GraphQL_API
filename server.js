...
var { pgquery, pgconnection } = require('./pg.js');
...
async function getEmployeeInterventions({ id }) {
...
pgconnection();
app.listen(3001, () => console.log('Express GraphQL Server Now Running On skyrock.ml/graphql'));